...
class PreprocessBoxscore(object):
  ...
  def input(self, home_team, away_team, scale_features=False):
    ...
    home_input = 0.1*home_season + 0.4*home_last_ten + 0.4*home_last_three + 0.1*home_at_home
    away_input = 0.1*away_season + 0.4*away_last_ten + 0.4*away_last_three + 0.1*away_at_away
